...
export const cases: CaseStudy[] = [
  {
    ...
    imageHeight: 658,
    imageAlt: {
      en: 'EdgeData equipment inventory interface',
      pt: 'Interface de inventário de equipamentos do EdgeData',
    },
  ...
  },
  {
    ...
    image: '/images/work/academic-operations.svg',
    imageWidth: 1200,
    imageHeight: 760,
    imageAlt: {
      en: 'System map of a multi-step academic enrollment journey',
      pt: 'Mapa de sistema de uma jornada acadêmica de matrícula em múltiplas etapas',
    },
  ...
  },
  {
    ...
    image: '/images/work/corporate-learning.svg',
    imageWidth: 1200,
    imageHeight: 760,
    imageAlt: {
      en: 'System map connecting audiences, learning journeys, content, integrations, and analytics',
      pt: 'Mapa de sistema conectando públicos, jornadas de aprendizagem, conteúdo, integrações e análises',
    },
    schemaType: 'CreativeWork',
  },
  {
  ...
  },
  {
    ...
    image: '/images/work/enterprise-operations.svg',
    imageWidth: 1200,
    imageHeight: 760,
    imageAlt: {
      en: 'Operational map connecting stores, teams, workflows, and central services',
      pt: 'Mapa operacional conectando lojas, equipes, workflows e serviços centrais',
    },
    schemaType: 'CreativeWork',
  },
];
